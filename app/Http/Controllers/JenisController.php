...
class JenisController extends Controller
{
    ...
    public function store(JenisRequest $request) {
        ...
        Session::flash('flash_message', 'Data jenis barang berhasil disimpan.');
    ...
    public function update(Jenis $jenis, JenisRequest $request) {
        ...
        Session::flash('flash_message', 'Data jenis barang berhasil diupdate.');
        return redirect('jenis');
    }

    public function destroy(Jenis $jenis) {
        $jenis->delete();
        Session::flash('flash_message', 'Data jenis barang berhasil dihapus.');
